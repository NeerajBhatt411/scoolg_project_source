            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20 items-center">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <a className="text-primary font-medium hover:text-primary-hover px-4 dark:text-blue-400 dark:hover:text-blue-300" href="/admin">Log In</a>
                ...
                <div className="md:hidden absolute top-20 left-0 w-full bg-white border-b border-gray-100 shadow-lg animate-fade-in-down dark:bg-slate-900 dark:border-slate-800">
                    <div className="flex flex-col p-4 space-y-4">
                        ...
                        <div className="flex flex-col gap-3 pt-4">
                            <a className="text-primary font-medium hover:text-primary-hover py-2 text-center border border-primary/20 rounded-lg dark:text-blue-400 dark:border-blue-400/30" href="/admin">Log In</a>
